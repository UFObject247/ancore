      ...
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-6 relative group hover:border-cyan-400/50 transition-all">
          <p className="text-[11px] font-mono text-cyan-300 break-all leading-relaxed bg-cyan-950/20 p-4 rounded-xl border border-cyan-400/20 mb-4 shadow-inner">
            {account?.publicKey ?? 'GA7W...A3XY'}
          </p>
          <button className="w-full rounded-2xl bg-cyan-400 py-4 text-[10px] font-black text-slate-950 shadow-[0_10px_25px_rgba(34,211,238,0.2)] hover:bg-cyan-300 active:scale-95 transition-all uppercase tracking-[0.2em]" aria-label="Copy address">
            Copy Address
          </button>
          <button className="mt-2 w-full rounded-2xl border border-cyan-300 py-3 text-[10px] font-black text-cyan-200 uppercase tracking-[0.2em]" aria-label="Print QR code">
            Print QR code
          </button>
        </div>
      </div>
